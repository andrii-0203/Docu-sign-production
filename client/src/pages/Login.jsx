...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-indigo-50 dark:bg-indigo-900/10 rounded-full blur-3xl opacity-50 pointer-events-none" />
                ...
                <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.1)] dark:shadow-none border border-slate-100 dark:border-slate-800">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">
                            Access your documents and signing workspace
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="group">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link to="/forgot-password" className="text-xs text-indigo-500 dark:text-indigo-400 hover:text-indigo-700 font-semibold">
                                    Forgot password?
                                </Link>
                            </div>
                        ...
                        <button
                            ...
                            className="w-full bg-indigo-600 text-white py-3.5 rounded-xl font-semibold hover:bg-indigo-700 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-200 dark:shadow-none mt-2 disabled:opacity-70 disabled:cursor-not-allowed group"
                        >
                            {isSubmitting ? (
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            ...
                            <Link to="/register" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-700 transition-colors">
                                Create account
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-6 flex justify-center">
                        <p className="text-[10px] text-slate-400 font-medium flex items-center gap-1.5 bg-slate-50 dark:bg-slate-800 px-3 py-1.5 rounded-full">
                            ...
                            JWT-secured sessions with audit logging
                        </p>
                    </div>
                </div>
            </div>
